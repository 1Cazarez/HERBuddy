...
const buddyProfiles = [
    ...
    { name: "Emily Torres", avatar: "🐱", year: "Junior", major: "Psychology", interests: ["Reading", "Art", "Coffee"], clubs: ["Psych Club"], events: ["HackHERS"], zone: "Aderhold Area", lookingFor: ["Study Buddy"], walkingStyle: "Casual", likedYou: false },
    { name: "Jasmine Lee", avatar: "🦊", year: "Freshman", major: "Business Administration", interests: ["Fitness", "Music", "Coffee"], clubs: ["Women in Business"], events: ["Career Fair"], zone: "Recreation Center Area", lookingFor: ["Walking Buddy"], walkingStyle: "Social", likedYou: false },
...
export function connectWithBuddy() {
    const buddy = buddyProfiles[currentMatchIndex];
    if (!buddy) return;
